export default class CommonMessage {
    ...
    public static readonly GalleryFile: string = 'Gallery File';
    ...
    public static readonly SlugUrl: string = 'Slug Url';
    ...
    public static readonly PostComment: string = 'Post Comment';
